...
export default function GlobalNav() {
  ...
  const navHidden = pathname.startsWith("/game") || pathname.startsWith("/pos") || pathname.startsWith("/order") || pathname.startsWith("/account") || pathname.startsWith("/track") || pathname === "/menu" || pathname.startsWith("/kiosk") || pathname.startsWith("/display") || pathname === "/clock" || pathname === "/scan" || pathname.startsWith("/employee") || pathname === "/signin";
