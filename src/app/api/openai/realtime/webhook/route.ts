import { calledDidFromSipHeaders,callerFromSipHeaders,lineForDid,openAiClient,openAiPhoneReadiness,OPENAI_HUMAN_HANDOFF_TOOL,OPENAI_MENU_SEARCH_TOOL,OPENAI_PHONE_GREETING,OPENAI_PRICE_ORDER_TOOL,OPENAI_VOICE_PAYMENT_TOOL,registerOpenAiCall,testDidAllowed } from "@/lib/openai-phone-ordering";
...
export async function POST(request:Request){
  ...
  try{
    ...
    await client.realtime.calls.accept(callId,{
      type:"realtime",model,output_modalities:["audio"],max_output_tokens:512,
      truncation:{type:"retention_ratio",retention_ratio:0.5,token_limits:{post_instructions:8000}},
