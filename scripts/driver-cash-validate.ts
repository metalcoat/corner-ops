...
async function main(){
  ...
  try{await withTransaction(async()=>{
    ...
    await sql`INSERT INTO ordering_order_delivery_addresses(order_id,entered_address,formatted_address,line1,city,state,postal_code,latitude,longitude,provider,validation_status,validated_at)VALUES(${orderId},'100 Cashout St','100 Cashout St, Ogdensburg, NY 13669','100 Cashout St','Ogdensburg','NY','13669',44.69,-75.48,'fixture','validated',NOW())`;
