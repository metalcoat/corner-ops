...
const SALAD="616994ef-6c0a-4f3f-b787-38abc7a481c9",SMALL="ffe07150-85f5-4f6c-9c24-019de8a1f562",LARGE="2d69bb22-8f82-40c8-b278-3feeb13d1e66";
...
async function main(){
  ...
  await withTransaction(async()=>{
    const sql=getSql();
    await sql`UPDATE ordering_modifier_groups SET allow_option_quantity=TRUE,max_selections=6,updated_at=NOW() WHERE id IN (${SMALL},${LARGE})`;
