...
const ITEM="665d3e4f-fe66-411a-834d-24f685e7b3eb",SOURCE="d4f85624-1228-4c7d-90cd-ba025b51dbea",HOT_DOG="d0900000-0000-4000-8000-000000000001";
...
async function main(){
  ...
  console.log(JSON.stringify({item:"Hot Dog",group:"Hot Dog Choices",burgerGroupHidden:true,freshPattyRemoved:true},null,2));
}
