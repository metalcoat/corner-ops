...
async function main(){
  ...
  const fixtures=[
    ...
    {key:"generic-pizza-pending-size",items:[{name:"Pizza",quantity:1}],errorCode:"INVALID_VARIANT"},
    {key:"invalid-turkey-burger",items:[{name:"turkey burger",quantity:1}],errorCode:"ITEM_NOT_ON_MENU"},
    {key:"invalid-pizza-avocado",items:[{name:"large pizza",quantity:1,modifiers:[{name:"pepperoni"},{name:"avocado"}]}],errorCode:"INVALID_MODIFIER"},
    {key:"wings-missing-count",items:[{name:"Wings",quantity:1,modifiers:[{name:"Mild"}]}],errorCode:"INVALID_VARIANT"},
    {key:"large-poutine-alias",items:[{name:"large pountine",quantity:1}],expectedItems:["Large French Fries"],expectedModifier:"Make it Poutine (Cheese & Gravy)"},
    {key:"tater-tot-poutine-missing-size",items:[{name:"tater tot poutine",quantity:1}],errorCode:"INVALID_VARIANT"},
    {key:"large-tater-tot-poutine",items:[{name:"large tater tot poutine",quantity:1}],expectedItems:["Large Tater Tots"],expectedModifier:"Make it Poutine (Cheese & Gravy)"},
    ...
    {key:"pizza-cheese-means-extra-cheese",items:[{name:"Pizza",variant:"Regular 14 inch",quantity:1,modifiers:[{name:"Cheese"}]}],errorCode:"INVALID_MODIFIER"},
    {key:"pizza-explicit-extra-cheese",items:[{name:"Pizza",variant:"Regular 14 inch",quantity:1,modifiers:[{name:"Extra Cheese"}]}],expectedItems:["Pizza"],expectedVariant:"Regular 14\"",expectedModifier:"Extra Cheese"},
    ...
    {key:"hot-roast-beef-sandwich",items:[{name:"hot roast beef sandwich",quantity:1}],errorCode:"INVALID_MODIFIER"},
